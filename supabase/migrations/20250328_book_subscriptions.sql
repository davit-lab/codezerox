...
-- Plans: Monthly 20₾, Yearly 120₾ (40% discount)
...
INSERT INTO book_subscription_plans (name, display_name, price_gel, interval, interval_count, description) VALUES
...
CREATE INDEX idx_book_subscriptions_status ON book_subscriptions(status);
CREATE INDEX idx_book_subscriptions_period_end ON book_subscriptions(current_period_end);
